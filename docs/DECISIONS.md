...
| OPEN-010 | Verify the selected real model runtime and strict output; keep provider/evidence class explicit | Complete | Resolved 2026-07-16 by ADR-031 and the human combined S043 receipt proving local strict output with explicit `local_model` evidence |
