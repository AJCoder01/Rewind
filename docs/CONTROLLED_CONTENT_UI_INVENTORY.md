...
The source and output contain no region, event, attendee, or meeting-time facts. Their byte hashes are generated by the existing SHA-256 domain helper and recorded in the plan; no literal recipient or provider identity is part of this inventory.
