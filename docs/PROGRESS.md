...
| G2 | `S031`–`S045`: OAuth, Calendar/Gmail/artifact/model primitives and live spikes | In progress | S031–S034 OAuth/provider boundaries passed; S035 is next and is TTY-gated; no live provider call has started |
