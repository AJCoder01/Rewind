...
- [ ] `S038` human-gated Gmail success and replay proof: send one uniquely identified allowlisted message, persist its receipt/replay key, and prove replay does not dispatch again.
