...
- [ ] **S009 — Provision and verify Vercel.** Follow [the manual S009 guide](S009_VERCEL_GUIDE.md): connect the GitHub repository, use Node 24 and Fluid Compute in Mumbai (`bom1`), configure the minimum private Production environment, deploy over TLS, and prove health/readiness, secure cookies, and the frozen base URL. The deployed create/review saga remains deferred to S023/S028 while the PostgreSQL store is fixture-backed.
