...
| Implementation | G1 closed; S031–S040 provider safety boundaries complete; S041 model-only schemas are next |
...
1. Continue with S041, the versioned model-only schemas task.
